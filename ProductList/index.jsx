    ...
    <div className="container py-20">
      <div className="grid grid-cols-4 gap-3 max-sm:grid-cols-1">
        <div className="col-span-3 ">
          <div className=" grid grid-cols-3 gap-4 my-[5rem] max-sm:grid-cols-1">
                    ...
                    {hovered === index && (
                      <div className=" absolute bottom-[0] mb-4 flex justify-center w-full mt-2 cursor-pointer">
                        <div class="hover:stroke-white relative flex flex-col items-center group">
                          <div
                            className={`hover:text-white mr-2 bg-white rounded-full p-1 hover:bg-gradient-to-b from-yellow-400 to-orange-600`}
                          >
                            <WishList />
                          </div>
